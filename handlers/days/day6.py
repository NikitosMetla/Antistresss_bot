...
async def oki_doki_day6(message: types.CallbackQuery, state: FSMContext, bot: Bot):
    ...
    await message.message.answer("Ну что, как успехи? Что стало источником стресса сегодня?")
...
async def answer_day6_1(message: types.Message, state: FSMContext, bot: Bot):
    await message.answer("Какие мысли при этом возникали? (Если стрессовых ситуаций было несколько, "
